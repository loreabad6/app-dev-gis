...
| 09.12.24 | (Spatial) data cleaning, wrangling & plotting |	Practical 4 | 09.01.25 |
| 16.12.24 | R-spatial ecosystem, vector, raster, data cubes |	Practical 5, final project	ideas |  End of class |
| 13.01.25 | GIS: in-house and bridges |  Data visualisation showcase  |    |
| 20.01.25 | R package development   |    |    |
| 27.01.25 | Quarto interactive dashboards   |    |    |
:::

The lessons are meant to give you a broad overview of the basics and of what is possible with R for spatial analysis.
_**Learning by yourself is highly encouraged and expected!**_
