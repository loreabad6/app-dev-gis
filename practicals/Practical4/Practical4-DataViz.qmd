...
Read what the developers of the packages have ardously worked on for your ease of using their package.
...
**We aim for a static map that you will be saving as a PNG file and submitting to blackboard alongside the code you used to create the map (either as an R script or a .qmd).**
