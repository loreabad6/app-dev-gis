---
title: "Practical 1 - Base R"
subtitle: "Application Development with R"
date: today
author: 
  - Team member 1
  - Team member 2
...
```{r}
top_secret <- read.csv("Secret_Code_AppDev", header = TRUE)$x
```

::: callout-tip
If you have errors in this one try: `readr::read.csv("Secret_Code_AppDev", header = TRUE)$x`

or come see me for help 🙃
:::
...
5.  Separately from your `top_secret` numbers, create a new vector called "evens" of all the even numbers between 1 and 428. That is, "evens" should contain 2, 4, 6, 8 ..., 428.
...
*Hint*: to make your code more legible, checkout the function `cat()`, you can access the help file by typing `?cat` on your console.
...
Upload the rendered html to Blackboard (don't forget to add all your teammates names!). The first team receives an extra point each in the final project 🏃
